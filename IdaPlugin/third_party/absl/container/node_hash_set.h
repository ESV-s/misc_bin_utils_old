...
class node_hash_set
 ...
 public:
  ...
  //
  // ѕ–»ћ≈„јЌ»≈: ’от¤ в STL не указано, какой элемент может быть вставлен
  // в случае эквивалентного сравнени¤ нескольких ключей в списке инициализатора,
  // дл¤ `node_hash_set` мы гарантируем вставку первого совпадени¤.
  using Base::insert;
