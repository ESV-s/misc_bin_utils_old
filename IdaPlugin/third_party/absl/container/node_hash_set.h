...
class node_hash_set
 ...
 public:
  ...
  //
  // ПРИМЕЧАНИЕ: Хотя в STL не указано, какой элемент может быть вставлен
  // в случае эквивалентного сравнения нескольких ключей в списке инициализатора,
  // для `node_hash_set` мы гарантируем вставку первого совпадения.
  using Base::insert;
