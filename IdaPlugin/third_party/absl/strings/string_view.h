...
class string_view {
 public:
  ...
  // Неявный конструктор `string_view` из NUL-терминированного `str`. 
  // При приеме возможно нулевых строк вместо этого используйте `absl::NullSafeStringView(str)` (см. ниже).
