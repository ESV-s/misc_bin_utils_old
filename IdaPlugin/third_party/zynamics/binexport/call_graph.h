...
class CallGraph {
 public:
  // Этот набор должен быть отсортирован.
  ...
  // Обратите внимание, что этот метод добавляет комментарий в конец вектора комментариев.
  // Другие функции, в частности GetComments(Address), ожидают, что вектор будет отсортирован. 
  // Поэтому будьте внимательны и пересортируйте комментарии после добавления.
