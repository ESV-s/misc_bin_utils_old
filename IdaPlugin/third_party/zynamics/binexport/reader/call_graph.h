...
namespace security::binexport {
	...
	public:
		...
		///\n
		/// Получить адрес вершины.
		Address GetAddress(Vertex vertex) const;
		///\n
		/// Возвращает true, если входные данные соответствуют корректной\n
		/// не-библиотечной, не-тонк, не-импортированной функции.\n
		/// Перегрузка, принимающая Address CHECK, терпит неудачу,\n
		/// если адрес не соответствует вершине в коллграфе.
