...
/// \brief \n Проверим настройки , и если нет какой либо из них - создадим ...\n
...
/// \file Settings.cpp
/// \brief \n Реализация подсистемы настроек плагина. \n
...
/// \brief \n Гарантирует, что init() уже был вызван. \n
///
...
/// \brief \n Инициализация подсистемы и загрузка state_ из QSettings. \n
void Settings::init()
{
...
/// \brief \n Финализация подсистемы (опциональная: на всякий случай синхронизируемся). \n
...
/// \brief \n Полная загрузка state_ из QSettings с дефолтами и валидацией. \n
...
/// \brief \n Полная запись state_ в QSettings (используется редко; сеттеры пишут точечно). \n
...
/// \brief \n Записывает один ключ в QSettings и синхронизирует хранилище. \n
/// \n
...
/// \brief \n Возвращает копию текущего снапшота. \n
