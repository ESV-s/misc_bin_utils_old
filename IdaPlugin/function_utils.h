...
/// \brief \n Вспомогательные функции для безопасной работы с функциями IDA: \n
...
/// \enum FuncKind
/// \brief \n Тип классификации адреса/функции. \n
///
/// \var FuncKind::None
...
/// \struct FuncClassify
/// \brief \n Результат классификации функции по адресу. \n
///
...
/// \brief \n Классифицирует адрес: определяет, является ли он частью head, tail-chunk или thunk. \n
/// \n
...
/// \brief \n Возвращает все диапазоны кода (head + tails) конкретной функции. \n
/// \n
...
/// \brief \n Резолвит цель thunk-функции (куда она переадресует вызов). \n
/// \n
