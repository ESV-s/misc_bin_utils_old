...
namespace security::binexport {
	...
	absl::Status DumpWriter::Write(const CallGraph& call_graph,
		...
		_RPT0(0, "absl::Status DumpWriter::Write");
	...
	absl::Status DumpWriter::WriteAdditional(
	...
	{
		stream_ << std::endl;
		call_graph.RenderAdditional(&stream_, flow_graph, exporter);
		stream_ << std::endl;
		flow_graph.RenderAdditional(&stream_, call_graph, exporter);
		stream_ << std::endl;
		return absl::OkStatus();
	}
