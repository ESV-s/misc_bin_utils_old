...
namespace security::binexport {
	...
	std::string GetTestTempPath(absl::string_view name) {
		// ѕри использовании Bazel переменна€ окружени€ TEST_TMPDIR гарантированно установлена.
		// —борка CMake также должна правильно ее установить.
		// See https://docs.bazel.build/versions/master/test-encyclopedia.html for details.
