...
namespace not_absl {
	...
	uint32_t LogEntry::GetCachedTID() {
		...
		///\n
		/// ѕриходитс€ обращатьс€ к внутренност€м Abseil, чтобы избежать дублировани€ кода дл€ конкретной платформы.
	...
	std::string LogEntry::ToString() const {
		...
		///\n
		/// Filename всегда содержит разделители путей Unix, так что это работает и в Windows.
