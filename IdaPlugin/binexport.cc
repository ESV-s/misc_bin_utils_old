...
namespace security::binexport {
	...
	Address GetInstructionAddress(const BinExport2& proto, int index) {
		// Либо в инструкции адрес хранится непосредственно, либо мы продолжаем итерацию предыдущих инструкций,
		// пока не найдем такую, добавляя правильное смещение.
		// При этом предполагается, что всегда найдется предыдущая инструкция с абсолютным адресом.
